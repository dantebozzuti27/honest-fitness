...
import {
  ...
  classifyExercise,
  classifyGeneratedExercise,
  classifyCorePattern,
  classifyCardioModality,
  classifyCnsDemandFromName,
  resolveToCanonicalGroup,
...
export {
  ...
  resolveLabelTokenToCanonical,
  NON_PRIMARY_THEME_GROUPS,
  THEME_LABEL_FAMILY_SYNONYMS,
} from './workoutTheme';
import {
  deriveDayTheme as _deriveDayTheme,
  type DayTheme as _DayTheme,
} from './workoutTheme';
type DayTheme = _DayTheme;
const deriveDayTheme = _deriveDayTheme;
 ...
 */
// DayTheme has moved to `./workoutTheme`. Re-exported above near the
// other theme exports.
export type { DayTheme } from './workoutTheme';

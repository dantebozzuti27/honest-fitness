...
export const EXERCISE_MUSCLE_MAP: Record<string, ExerciseMapping> = {
  ...
  'Decline Barbell Bench Press': {
    primary_muscles: ['pectoralis_major_lower', 'triceps_lateral_head', 'triceps_medial_head'],
    secondary_muscles: ['pectoralis_major_sternal', 'anterior_deltoid'],
    stabilizer_muscles: ['serratus_anterior'],
    movement_pattern: 'horizontal_push', exercise_type: 'compound', force_type: 'push', difficulty: 'intermediate',
    default_tempo: '2-1-1',
    functional_description: 'Decline angle maximizes lower sternal pec recruitment and reduces anterior deltoid contribution.',
    stimulus_to_fatigue_ratio: 2,
  },
  'Machine Chest Press': {
    primary_muscles: ['pectoralis_major_sternal', 'pectoralis_major_clavicular', 'triceps_lateral_head'],
  ...
  'Chest Dip': {
    primary_muscles: ['pectoralis_major_lower', 'triceps_lateral_head', 'triceps_medial_head'],
    secondary_muscles: ['pectoralis_major_sternal', 'anterior_deltoid', 'pectoralis_minor'],
    stabilizer_muscles: ['rectus_abdominis', 'serratus_anterior'],
  ...
  'Ring Dip': {
    ...
    default_tempo: '2-1-1',
    functional_description: 'Unstable ring dip with extreme stability demands. Lower chest and triceps compound with rotator cuff stabilization.',
    stimulus_to_fatigue_ratio: 1.5,
  },
  ...
  'Decline Machine Chest Press': {
    primary_muscles: ['pectoralis_major_lower', 'triceps_lateral_head'],
    secondary_muscles: ['pectoralis_major_sternal', 'anterior_deltoid'],
    stabilizer_muscles: [],
    movement_pattern: 'horizontal_push', exercise_type: 'compound', force_type: 'push', difficulty: 'beginner',
    default_tempo: '2-1-1',
    functional_description: 'Machine-guided decline press for lower chest isolation.',
    stimulus_to_fatigue_ratio: 3.5,
  },
  ...
  'High-to-Low Cable Fly': {
    primary_muscles: ['pectoralis_major_lower', 'pectoralis_minor'],
    secondary_muscles: ['pectoralis_major_sternal', 'anterior_deltoid'],
    stabilizer_muscles: ['rectus_abdominis'],
    movement_pattern: 'horizontal_push', exercise_type: 'isolation', force_type: 'push', difficulty: 'beginner',
    default_tempo: '2-1-2',
    functional_description: 'High-to-low path follows lower sternal pec fiber direction for lower chest emphasis.',
    stimulus_to_fatigue_ratio: 5,
  },
  'Pec Deck Fly': {
    primary_muscles: ['pectoralis_major_sternal', 'pectoralis_major_clavicular'],
  ...
  'Reverse Barbell Curl': {
    ...
    secondary_muscles: ['biceps_brachii_long_head', 'wrist_extensors'],
    stabilizer_muscles: ['anterior_deltoid'],
  ...
  'Cable Rope Hammer Curl': {
    primary_muscles: ['brachialis', 'brachioradialis', 'biceps_brachii_long_head'],
    secondary_muscles: ['biceps_brachii_short_head'],
    stabilizer_muscles: ['rectus_abdominis'],
    movement_pattern: 'flexion', exercise_type: 'isolation', force_type: 'pull', difficulty: 'beginner',
    default_tempo: '2-1-2',
  ...
  'Single-Arm Cable Curl': {
    primary_muscles: ['biceps_brachii_short_head', 'biceps_brachii_long_head'],
    secondary_muscles: ['brachialis'],
    stabilizer_muscles: ['rectus_abdominis', 'obliques'],
    movement_pattern: 'flexion', exercise_type: 'isolation', force_type: 'pull', difficulty: 'beginner',
    default_tempo: '2-1-2',
  ...
  'Cross-Body Hammer Curl': {
    primary_muscles: ['brachialis', 'biceps_brachii_long_head'],
    secondary_muscles: ['brachioradialis', 'biceps_brachii_short_head'],
    stabilizer_muscles: ['anterior_deltoid'],
    movement_pattern: 'flexion', exercise_type: 'isolation', force_type: 'pull', difficulty: 'beginner',
    default_tempo: '2-1-2',

...
('Dumbbell Bulgarian Split Squat', 'strength', 'legs', array['quads','glutes'], array['dumbbell','bench'], false, 'Rear-foot elevated split squat with dumbbells.'),
...
('Dumbbell Walking Lunge', 'strength', 'legs', array['quads','glutes','hamstrings'], array['dumbbell'], false, 'Walking lunge with dumbbells.'),
...
('Dumbbell Reverse Lunge', 'strength', 'legs', array['glutes','quads'], array['dumbbell'], false, 'Reverse lunge with dumbbells.'),
...
('Dumbbell Step-Up', 'strength', 'legs', array['quads','glutes'], array['dumbbell','box','bench'], false, 'Step-up holding dumbbells.'),
...
('Dumbbell Romanian Deadlift', 'strength', 'legs', array['hamstrings','glutes'], array['dumbbell'], false, 'RDL with dumbbells.'),
...
('Dumbbell Single-Leg Romanian Deadlift', 'strength', 'legs', array['hamstrings','glutes','core'], array['dumbbell'], false, 'Unilateral hinge with dumbbells.'),
...
('Dumbbell Hip Thrust', 'strength', 'legs', array['glutes','hamstrings'], array['dumbbell','bench'], false, 'Hip thrust holding a dumbbell.'),
...
('Dumbbell Calf Raise', 'strength', 'legs', array['calves'], array['dumbbell'], false, 'Calf raise holding dumbbells.'),
...
('Dumbbell Bench Press', 'strength', 'chest', array['pecs','triceps','front_delts'], array['dumbbell','bench'], false, 'Flat dumbbell press.'),
...
('Incline Dumbbell Bench Press', 'strength', 'chest', array['upper_pecs','triceps','front_delts'], array['dumbbell','bench'], false, 'Incline dumbbell press.'),
...
('Dumbbell Fly', 'strength', 'chest', array['pecs'], array['dumbbell','bench'], false, 'Chest fly with dumbbells.'),
('Incline Dumbbell Fly', 'strength', 'chest', array['upper_pecs'], array['dumbbell','bench'], false, 'Incline fly focusing upper chest.'),
...
('One-Arm Dumbbell Row', 'strength', 'back', array['lats','upper_back','biceps'], array['dumbbell','bench'], false, 'Unilateral row supported on bench.'),
('Chest-Supported Dumbbell Row', 'strength', 'back', array['upper_back','rhomboids','lats'], array['dumbbell','bench'], false, 'Incline bench supported row.'),
...
('Dumbbell Rear Delt Fly', 'strength', 'shoulders', array['rear_delts','upper_back'], array['dumbbell'], false, 'Bent-over rear-delt fly.'),
('Shrug', 'strength', 'shoulders', array['traps'], array['dumbbell','barbell'], false, 'Trap shrug.'),
...
('Dumbbell Shoulder Press', 'strength', 'shoulders', array['front_delts','triceps'], array['dumbbell','bench'], false, 'Seated or standing DB press.'),
('Arnold Press', 'strength', 'shoulders', array['front_delts','side_delts','triceps'], array['dumbbell'], false, 'Rotational dumbbell press.'),
...
('Dumbbell Lateral Raise', 'strength', 'shoulders', array['side_delts'], array['dumbbell'], false, 'Lateral raise for side delts.'),
('Cable Lateral Raise', 'strength', 'shoulders', array['side_delts'], array['cable'], false, 'Lateral raise using cable.'),
('Dumbbell Front Raise', 'strength', 'shoulders', array['front_delts'], array['dumbbell'], false, 'Front delt isolation raise.'),
('Cable Front Raise', 'strength', 'shoulders', array['front_delts'], array['cable'], false, 'Front raise using cable.'),
('Upright Row', 'strength', 'shoulders', array['side_delts','traps'], array['barbell','dumbbell','cable'], false, 'Vertical pull to chest height.'),
...
('Dumbbell Biceps Curl', 'strength', 'arms', array['biceps'], array['dumbbell'], false, 'Alternating or simultaneous DB curl.'),
('Hammer Curl', 'strength', 'arms', array['biceps','brachialis','forearms'], array['dumbbell'], false, 'Neutral-grip curl.'),
('Incline Dumbbell Curl', 'strength', 'arms', array['biceps'], array['dumbbell','bench'], false, 'Incline bench stretch curl.'),
('Preacher Curl', 'strength', 'arms', array['biceps'], array['machine','barbell','dumbbell'], false, 'Curl supported on preacher pad.'),
...
('Overhead Triceps Extension', 'strength', 'arms', array['triceps'], array['dumbbell','cable'], false, 'Overhead extension emphasizing long head.'),
('Skull Crusher', 'strength', 'arms', array['triceps'], array['barbell','dumbbell','bench'], false, 'Lying triceps extension.'),
...
('Dumbbell Triceps Kickback', 'strength', 'arms', array['triceps'], array['dumbbell'], false, 'Triceps kickback.'),
('Wrist Curl', 'strength', 'arms', array['forearms'], array['dumbbell','barbell'], false, 'Forearm flexor curl.'),
('Reverse Wrist Curl', 'strength', 'arms', array['forearms'], array['dumbbell','barbell'], false, 'Forearm extensor curl.'),
('Farmer Carry', 'strength', 'full_body', array['forearms','core','traps'], array['dumbbell','kettlebell'], false, 'Loaded carry for grip and trunk.'),
...
('Dumbbell Thruster', 'strength', 'full_body', array['quads','glutes','shoulders'], array['dumbbell'], false, 'Front squat into overhead press.'),
...
('Farmer Carry (Conditioning)', 'cardio', 'cardio', array['full_body'], array['dumbbell','kettlebell'], false, 'Continuous loaded carry conditioning.'),
...
-- =========================
('Dumbbell Floor Press', 'strength', 'chest', array['pecs','triceps'], array['dumbbell'], false, 'Press lying on floor; limits shoulder extension.'),
...
('Dumbbell Front-Foot Elevated Split Squat', 'strength', 'legs', array['quads','glutes'], array['dumbbell','plate'], false, 'FFESS with dumbbells.'),
...
('Dumbbell Lateral Lunge', 'strength', 'legs', array['adductors','glutes'], array['dumbbell'], false, 'Side lunge with dumbbells.'),

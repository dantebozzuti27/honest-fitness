...
export const SYNERGIST_FATIGUE: Partial<Record<CanonicalMuscleGroup, Partial<Record<CanonicalMuscleGroup, number>>>> = {
  upper_chest: { triceps: 0.4, anterior_deltoid: 0.5, mid_chest: 0.3, lower_chest: 0.2 },
  mid_chest: { triceps: 0.4, anterior_deltoid: 0.5, upper_chest: 0.3, lower_chest: 0.3 },
  lower_chest: { triceps: 0.5, mid_chest: 0.3, anterior_deltoid: 0.3 },
  back_lats: { biceps: 0.35, forearms: 0.25, posterior_deltoid: 0.2, lower_traps: 0.15, back_upper: 0.25, mid_traps: 0.2, rotator_cuff: 0.1 },
  back_upper: { biceps: 0.3, mid_traps: 0.3, forearms: 0.2, back_lats: 0.2, posterior_deltoid: 0.25 },
  ...
  lateral_deltoid: { upper_traps: 0.15, anterior_deltoid: 0.25, triceps: 0.2, mid_chest: 0.1 },
  posterior_deltoid: { mid_traps: 0.15, rotator_cuff: 0.1, back_upper: 0.2 },
  biceps: { forearms: 0.3, back_lats: 0.15, back_upper: 0.15 },
  triceps: { mid_chest: 0.1, anterior_deltoid: 0.1, lateral_deltoid: 0.15 },
  quadriceps: { glutes: 0.4, core: 0.2, erector_spinae: 0.15, hip_flexors: 0.2, hamstrings: 0.2, abductors: 0.15, adductors: 0.15, calves: 0.15 },
  hamstrings: { glutes: 0.35, erector_spinae: 0.3, quadriceps: 0.15, calves: 0.1 },
  glutes: { hamstrings: 0.2, quadriceps: 0.15, abductors: 0.25, adductors: 0.1, erector_spinae: 0.15 },

...
const EXERCISE_MAP = {
  ...
  'Pendulum Squat': { primary: ['rectus_femoris','vastus_lateralis','vastus_medialis','vastus_intermedius'], secondary: ['gluteus_maximus','adductors'], stabilizer: [], pattern: 'squat', type: 'compound', force: 'push', diff: 'beginner', tempo: '3-1-1' },
